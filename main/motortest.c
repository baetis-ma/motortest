...
void app_main()
{
    ...
    while(1) {
        ...
        vTaskDelay(333/portTICK_RATE_MS);  //wait a third of a second
    }
}
...
//  sprintf(espTxData, "data,%0.4f,%0.4f,%0.6f,%0.2f,\n", 
//       batteryvlp, currentlp, (float)(filter/1000000.0),(float)(1000000.0/filter));
//  printf("voltage = %7.4f %7.4f  rps= %7.6f  pwm= %5.2f throttle= %5d\n", 
//       batteryvlp, currentlp, (float)(filter/1000000.0),(float)(1000000.0/filter),pwm);
//}
